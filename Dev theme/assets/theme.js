...
(function (a) {
  a.fn.prepareTransition = function () {
    return this.each(function () {
      var b = a(this);b.one("TransitionEnd webkitTransitionEnd transitionend oTransitionEnd", function () {
        b.removeClass("is-transitioning");
      });var c = ["transition-duration", "-moz-transition-duration", "-webkit-transition-duration", "-o-transition-duration"];var d = 0;a.each(c, function (a, c) {
        d = parseFloat(b.css(c)) || d;
      });if (d != 0) {
        b.addClass("is-transitioning");b[0].offsetWidth;
      }
    });
  };
})(jQuery);
...
function replaceUrlParam(e, r, a) {
  var n = new RegExp("(" + r + "=).*?(&|$)"),
      c = e;return c = e.search(n) >= 0 ? e.replace(n, "$1" + a + "$2") : c + (c.indexOf("?") > 0 ? "&" : "?") + r + "=" + a;
};
...
jQuery(function ($) {
  $(document).ready(function () {
    var vartop;var varscroll;var contentButton = [];var contentTop = [];var content = [];var lastScrollTop = 0;var scrollDir = '';var itemClass = '';var itemHover = '';var menuSize = null;var stickyHeight = 0;var stickyMarginB = 0;var currentMarginT = 0;var topMargin = 0;$(window).scroll(function (event) {
      ...
      $(this).addClass('stuckMenu');var objn = 0;if (options != null) {
        ...
        }itemClass = options.itemClass;itemHover = options.itemHover;if (options.topMargin != null) {
      ...
      varscroll = parseInt($(document).scrollTop());if (menuSize != null) {
        for (var i = 0; i < menuSize; i++) {
          var bottomView = function bottomView(i) {
            contentView = $('#' + content[i] + '').height() * .4;testView = contentTop[i] - contentView;if (varscroll > testView) {
              $('.' + itemClass).removeClass(itemHover);$('.' + itemClass + ':eq(' + i + ')').addClass(itemHover);
            } else if (varscroll < 50) {
              $('.' + itemClass).removeClass(itemHover);$('.' + itemClass + ':eq(0)').addClass(itemHover);
            }
          };

          contentTop[i] = $('#' + content[i] + '').offset().top;if (scrollDir == 'down' && varscroll > contentTop[i] - 50 && varscroll < contentTop[i] + 50) {
            $('.' + itemClass).removeClass(itemHover);$('.' + itemClass + ':eq(' + i + ')').addClass(itemHover);
          }if (scrollDir == 'up') {
            bottomView(i);
          }
        ...
        $('.stuckMenu').addClass('isStuck');$('.stuckMenu').next().closest('div').css({ 'margin-top': stickyHeight + stickyMarginB + currentMarginT + 'px' }, 10);$('.stuckMenu').css("position", "fixed");$('.isStuck').css({ top: '0px' }, 10, function () {});
      };if (varscroll + topMargin < vartop) {
        $('.stuckMenu').removeClass('isStuck');$('.stuckMenu').next().closest('div').css({ 'margin-top': currentMarginT + 'px' }, 10);$('.stuckMenu').css("position", "relative");
      };
    });
  });
});
...
!function (e, a, t) {
  function l(e) {
    var a = {},
        l = /^jQuery\d+$/;return t.each(e.attributes, function (e, t) {
      t.specified && !l.test(t.name) && (a[t.name] = t.value);
    }), a;
  }function r(e, l) {
    var r = this,
        o = t(r);if (r.value == o.attr("placeholder") && o.hasClass("placeholder")) if (o.data("placeholder-password")) {
      if (o = o.hide().next().show().attr("id", o.removeAttr("id").data("placeholder-id")), e === !0) return o[0].value = l;o.focus();
    } else r.value = "", o.removeClass("placeholder"), r == a.activeElement && r.select();
  }function o() {
    var e,
        a = this,
        o = t(a),
        d = this.id;if ("" == a.value) {
      if ("password" == a.type) {
        if (!o.data("placeholder-textinput")) {
          ...
          }e.removeAttr("name").data({ "placeholder-password": !0, "placeholder-id": d }).bind("focus.placeholder", r), o.data({ "placeholder-textinput": e, "placeholder-id": d }).before(e);
      ...
      h = t.fn,
      u = t.valHooks;n && i ? (c = h.placeholder = function () {
    return this;
  }, c.input = c.textarea = !0) : (c = h.placeholder = function () {
    var e = this;return e.filter((n ? "textarea" : ":input") + "[placeholder]").not(".placeholder").bind({ "focus.placeholder": r, "blur.placeholder": o }).data("placeholder-enabled", !0).trigger("blur.placeholder"), e;
  }, c.input = n, c.textarea = i, d = { get: function get(e) {
      var a = t(e);return a.data("placeholder-enabled") && a.hasClass("placeholder") ? "" : e.value;
    }, set: function set(e, l) {
      var d = t(e);return d.data("placeholder-enabled") ? ("" == l ? (e.value = l, e != a.activeElement && o.call(e)) : d.hasClass("placeholder") ? r.call(e, !0, l) || (e.value = l) : e.value = l, d) : e.value = l;
    } }, n || (u.input = d), i || (u.textarea = d), t(function () {
    t(a).delegate("form", "submit.placeholder", function () {
      var e = t(".placeholder", this).each(r);setTimeout(function () {
        e.each(o);
      }, 10);
    });
...
!function (e) {
  ...
  function n(e) {
    ...
    var i = u.raw ? n : r(n);return e.isFunction(o) ? o(i) : i;
  }var c = /\+/g,
      u = e.cookie = function (r, c, a) {
    if (void 0 !== c && !e.isFunction(c)) {
      if (a = e.extend({}, u.defaults, a), "number" == typeof a.expires) {
        var d = a.expires,
            f = a.expires = new Date();f.setTime(+f + 864e5 * d);
    ...
    }for (var s = r ? void 0 : {}, p = document.cookie ? document.cookie.split("; ") : [], m = 0, v = p.length; v > m; m++) {
      var x = p[m].split("="),
          k = o(x.shift()),
          l = x.join("=");if (r && r === k) {
        s = t(l, c);break;
...
;(function () {
  function n(n, t) {
    ...
    for (var e = -1, u = n.length; ++e < u;) {
      var o = n[e],
          i = t(o);if (null != i && (c === an ? i === i : r(i, c))) var c = i,
          f = o;
    }return f;
  }function r(n, t, r) {
    ...
    if (Y(n) && !Pn(n)) {
      if (n instanceof l) return n;if (En.call(n, "__wrapped__")) {
        var t = new l(n.__wrapped__, n.__chain__);return t.__actions__ = N(n.__actions__), t;
      }
    }return new l(n);
  }function l(n, t) {
    this.__wrapped__ = n, this.__actions__ = [], this.__chain__ = !!t;
  }function p(n, t, r, e) {
    var u;return (u = n === an) || (u = xn[r], u = (n === u || n !== n && u !== u) && !En.call(e, r)), u ? t : n;
  }function s(n) {
    return X(n) ? Fn(n) : {};
  }function h(n, t, r) {
    ...
    var r = true;return $n(n, function (n, e, u) {
      return r = !!t(n, e, u);
    }), r;
  }function y(n, t) {
    ...
    var i = Pn(n),
        f = Pn(t),
        a = "[object Array]",
        l = "[object Array]";i || (a = kn.call(n), "[object Arguments]" == a && (a = "[object Object]")), f || (l = kn.call(t), "[object Arguments]" == l && (l = "[object Object]"));var p = "[object Object]" == a && !c(n),
        f = "[object Object]" == l && !c(t);return !(l = a == l) || i || p ? 2 & u || (a = p && En.call(n, "__wrapped__"), f = f && En.call(t, "__wrapped__"), !a && !f) ? l ? (o || (o = []), (a = J(o, function (t) {
      return t[0] === n;
    })) && a[1] ? a[1] == t : (o.push([n, t]), t = (i ? I : q)(n, t, r, e, u, o), o.pop(), t)) : false : r(a ? n.value() : n, f ? t.value() : t, e, u, o) : $(n, t, a);
  }function d(n) {
    var t = typeof n === "undefined" ? "undefined" : _typeof(n);return "function" == t ? n : null == n ? cn : ("object" == t ? x : A)(n);
  }function w(n) {
    ...
    var r = -1,
        e = L(n) ? Array(n.length) : [];return $n(n, function (n, u, o) {
      e[++r] = t(n, u, o);
    }), e;
  }function x(n) {
    var t = en(n);return function (r) {
      var e = t.length;if (null == r) return !e;for (r = Object(r); e--;) {
        var u = t[e];if (!(u in r && j(n[u], r[u], an, 3))) return false;
      }return true;
    };
  }function E(n, t) {
    ...
    r || (r = {});for (var u = -1, o = t.length; ++u < o;) {
      var i = t[u],
          ...
          f = r,
          a = f[i];En.call(f, i) && (a === c || a !== a && c !== c) && (c !== an || i in f) || (f[i] = c);
    }return r;
  }function R(n) {
    return V(function (t, r) {
      var e = -1,
          u = r.length,
          o = u > 1 ? r[u - 1] : an,
          o = typeof o == "function" ? (u--, o) : an;for (t = Object(t); ++e < u;) {
    ...
    var i = -1,
        c = 1 & u,
        f = n.length,
        a = t.length;if (f != a && !(2 & u && a > f)) return false;for (a = true; ++i < f;) {
      var l = n[i],
          p = t[i];if (void 0 !== an) {
        a = false;break;
      }if (c) {
    ...
    var i = 2 & u,
        c = en(n),
        f = c.length,
        a = en(t).length;if (f != a && !i) return false;for (var l = f; l--;) {
      var p = c[l];if (!(i ? p in t : En.call(t, p))) return false;
    }for (a = true; ++l < f;) {
      var p = c[l],
          s = n[p],
          h = t[p];if (void 0 !== an || s !== h && !r(s, h, e, u, o)) {
        a = false;break;
      }i || (i = "constructor" == p);
    ...
    var t = n ? n.length : an;if (W(t) && (Pn(n) || nn(n) || K(n))) {
      n = String;for (var r = -1, e = Array(t); ++r < t;) {
        e[r] = n(r);
      }t = e;
    ...
    var r;if (typeof t != "function") throw new TypeError("Expected a function");return n = Un(n), function () {
    ...
    var t = C(n);if (!t && !L(n)) return Dn(Object(n));var r,
        e = z(n),
        u = !!e,
        e = e || [],
    ...
    var u = en(r),
        o = b(r, u);null != e || X(r) && (o.length || !u.length) || (e = r, r = t, t = this, o = b(r, en(r)));var i = X(e) && "chain" in e ? e.chain : true,
        c = Q(t);return $n(o, function (e) {
      var u = r[e];t[e] = u, c && (t.prototype[e] = function () {
        var r = this.__chain__;if (i || r) {
          var e = t(this.__wrapped__);return (e.__actions__ = N(this.__actions__)).push({ func: u, args: arguments,
            thisArg: t }), e.__chain__ = r, e;
      ...
      _n = yn[typeof exports === "undefined" ? "undefined" : _typeof(exports)] && exports && !exports.nodeType ? exports : an,
      gn = yn[typeof module === "undefined" ? "undefined" : _typeof(module)] && module && !module.nodeType ? module : an,
      ...
      $n = function (n, t) {
    return function (r, e) {
      if (null == r) return r;if (!L(r)) return n(r, e);for (var u = r.length, o = t ? u : -1, i = Object(r); (t ? o-- : ++o < u) && false !== e(i[o], o, i);) {}return r;
    };
  }(g),
      qn = function (n) {
  ...
  }();Tn && !Rn.call({ valueOf: 1 }, "valueOf") && (w = function w(n) {
    n = Tn(n);for (var t, r = []; !(t = n.next()).done;) {
      r.push(t.value);
    }return r;
  });var zn = A("length"),
      Cn = V(function (t, r) {
    ...
    return null == n ? {} : E(n, _(t, 1));
      ...
      Xn = d;l.prototype = s(a.prototype), l.prototype.constructor = l, a.assignIn = Kn, a.before = U, a.bind = Gn, a.chain = function (n) {
    return n = a(n), n.__chain__ = true, n;
  }, a.compact = function (n) {
    return y(n, Boolean);
  }, a.concat = Cn, a.create = function (n, t) {
    var r = s(n);return t ? Hn(r, t) : r;
    ...
    var e = n ? n.length : 0;return r = r === an ? e : +r, e ? k(n, null == t ? 0 : +t, r) : [];
  }, a.sortBy = function (n, t) {
    var r = 0;return t = d(t), O(O(n, function (n, e, u) {
    ...
    var e = n ? n.length : 0;r = typeof r == "number" ? 0 > r ? In(e + r, 0) : r : 0, r = (r || 0) - 1;for (var u = t === t; ++r < e;) {
    ...
    if (L(n) && (Pn(n) || nn(n) || Q(n.splice) || K(n))) return !n.length;for (var t in n) {
    ...
    var t = n ? n.length : 0;return t ? n[t - 1] : an;
  }, a.max = function (n) {
    ...
    var t = ++An;return rn(n) + t;
  }, a.each = M, a.first = G, fn(a, function () {
    var n = {};return g(a, function (t, r) {
  ...
  }, (mn || jn || {})._ = a, typeof define == "function" && _typeof(define.amd) == "object" && define.amd ? define(function () {
    return a;
...
theme.Header = function () {
  function Header(container) {
    ...
    if (ui.mobileNavButton && ui.mobileNavMenu) {
      ui.mobileNavButton.on('click', function () {
    ...
    if (ui.mobileSitesPicker) {
      ui.mobileSitesPicker.on('click', function () {
...
theme.ColumnsCarousel = function () {
  function ColumnsCarousel(container) {
    ...
    };var initColumnsCarousel = function initColumnsCarousel(Columnscarousel) {
...
theme.Testimonials = function () {
  function Testimonials(container) {
    ...
    var initTestimonials = function initTestimonials(Testimonialcarousel) {
      Testimonialcarousel.owlCarousel({
        itemsCustom: [[0, 1], [450, 1], [600, 1], [700, 1], [1000, 2], [1200, 3], [1400, 3], [1600, 3]],
        navigation: false,
        pagination: true
      });
    };
...
theme.FeaturedProducts = function () {
  function FeaturedProducts(container) {
    ...
    var initHomepageCarousel = function initHomepageCarousel(productCarousel) {
      productCarousel.owlCarousel({
        itemsCustom: [[0, 2], [450, 2], [600, 2], [700, 3], [1000, 4], [1200, 6], [1400, 6], [1600, 6]],
        lazyLoad: true,
        pagination: false,
        navigation: true,
...
theme.Parallax = function () {
  function Parallax(container) {
    ...
    var initParallaximage = function initParallaximage(ParallaxImages) {
...
$(document).ready(function () {
  ...
  $(".product-collection-carousel").owlCarousel({
    itemsCustom: [[0, 2], [450, 2], [600, 2], [700, 2], [1000, 4], [1200, 4], [1400, 4], [1600, 5]],
    lazyLoad: true,
    navigation: true,
    navigationText: ["", ""],
    pagination: false
...
theme.ProductForm = function (context, events) {
  ...
  (function swatches() {
    ...
    var states = {
      sold_out: function sold_out(element) {
        element.parentElement.classList.add("soldout");
      },
      available: function available(element) {
...
theme.ProductGallery = function (context, events) {
  ...
  (function main_images() {
    ...
    function select(id) {
      ...
      $elements.removeClass("selected").hide().filter(image).addClass("selected").show();
    };
  })();
  ...
  (function thumbnail_slider() {
    var initThumbSlider = function initThumbSlider(prodSlideshow) {
...
/* Search Popup */
$( document ).ready(function() {
  $('.search-trigger').on('click tap',this,function() {
    $(this).toggleClass('is-on');
    $('.top-search').slideToggle();
  });

  $('.top-search .close').on('click tap',this,function() {
    $('.top-search').slideToggle();
    $('.search-trigger').toggleClass('is-on');
  });   
});